            ...
            >
                <SwiperSlide>
                    ...
                    <div className='absolute text-center justify-center items-center space-y-4 bg-gradient-to-r from-zinc-500 w-full h-full flex flex-col '>
                        <h1 className='text-success font-bold text-7xl'>MAKE YOUR SUMMER</h1>
                        <p className='text-success font-bold text-5xl'>Improve your skills with us</p>
                        <button className='w-[180px] btn btn-success btn-lg rounded-full'>Enroll Now</button>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
